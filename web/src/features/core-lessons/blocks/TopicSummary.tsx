...
export const TopicSummary: React.FC<TopicSummaryProps> = ({ content, keyPoints }) => {
    return (
        <div className="group bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20 rounded-2xl p-6 my-6 hover:-translate-y-1 transition-all duration-300 hover:shadow-lg hover:shadow-primary/10 hover:border-primary/40">
