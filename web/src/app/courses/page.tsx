        ...
        <div className="min-h-screen bg-background font-sans text-foreground pb-24 relative overflow-hidden" dir="rtl">
                ...
                <div className="fixed inset-0 z-[100] bg-black/40 backdrop-blur-sm flex justify-end">
                    <div className="w-80 h-full bg-card border-r border-border shadow-2xl animate-in slide-in-from-right duration-300">
                        <div className="p-8 border-b border-border flex justify-between items-center bg-primary/[0.02]">
                            <span className="text-xl font-black text-foreground">תפריט</span>
                            <button onClick={() => setIsSidebarOpen(false)} className="p-2 hover:bg-primary/10 rounded-2xl transition-colors text-foreground/50 hover:text-foreground">
                                <X className="w-8 h-8" />
                            </button>
                        </div>
                        <nav className="p-8 space-y-6">
                            <Link
                                href="/"
                                className="flex items-center gap-4 p-4 rounded-2xl hover:bg-primary/5 transition-all text-foreground/70 hover:text-foreground font-black"
                            ...
                            <Link
                                href="/courses"
                                className="flex items-center gap-4 p-4 rounded-2xl bg-primary/10 border border-primary/20 text-foreground hover:bg-primary/20 transition-all font-black"
                                onClick={() => setIsSidebarOpen(false)}
                            >
            ...
            <header className="sticky top-0 z-50 w-full bg-background/80 backdrop-blur-xl border-b border-border">
                <div className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto">
                    <div className="flex items-center gap-6">
                        <button
                            ...
                            className="p-3 rounded-2xl hover:bg-primary/5 transition-colors text-foreground/40 hover:text-foreground lg:hidden"
                        >
                    ...
                    <div className="flex items-center gap-4">
                        <button className="p-3 rounded-2xl hover:bg-primary/5 transition-colors text-foreground/40 hover:text-foreground shadow-sm border border-transparent hover:border-border">
                            <Search className="w-6 h-6" />
                        </button>
                        <button className="p-3 rounded-2xl bg-primary text-foreground shadow-lg shadow-primary/20 transition-all hover:translate-y-[-2px] hover:shadow-primary/30">
                ...
                <div className="max-w-7xl mx-auto flex gap-4 px-6 pb-6 overflow-x-auto no-scrollbar scroll-smooth">
                    <button className="flex h-11 shrink-0 items-center justify-center gap-x-3 rounded-2xl bg-primary px-8 text-foreground shadow-lg shadow-primary/20 font-black text-sm">
                        <span className="">הכל</span>
                    </button>
                    <button className="flex h-11 shrink-0 items-center justify-center gap-x-3 rounded-2xl bg-white border border-border px-6 text-foreground/70 hover:bg-primary/5 hover:text-foreground transition-all font-black text-sm shadow-sm group">
                        <span>פקולטה</span>
            ...
            <main className="px-6 py-12 max-w-7xl mx-auto space-y-12 relative z-10">
                <section className="space-y-4">
                    <div className="flex items-center gap-4">
                        ...
                        <h2 className="text-[12px] font-black text-foreground uppercase tracking-[0.5em] font-sans">Knowledge Sanctuary</h2>
                    </div>
            ...
            <div className="fixed bottom-24 left-10 z-40">
                <button className="w-20 h-20 rounded-[2rem] bg-primary shadow-2xl shadow-primary/40 flex items-center justify-center text-foreground transition-all hover:scale-110 active:scale-95 group relative border-4 border-card">
            ...
            <nav className="fixed bottom-0 left-0 right-0 h-24 bg-background/80 backdrop-blur-2xl border-t border-border flex items-center justify-around px-8 pb-8 z-50 lg:hidden shadow-premium">
                <button className="flex flex-col items-center gap-2 text-foreground font-black">
                    <BookOpen className="w-8 h-8" />
                    <span className="text-[10px] uppercase tracking-widest">קורסים</span>
                </button>
                <button className="flex flex-col items-center gap-2 text-foreground/30 hover:text-foreground transition-colors font-black">
