...
import { courseData } from "@/data/courses/organizational-behavior";
    ...
    return (
        <div className="min-h-screen bg-slate-950 font-sans text-slate-100 pb-24" dir="rtl">
                ...
                <div className="max-w-7xl mx-auto px-6 py-24 relative z-10">
                    <div className="flex flex-col md:flex-row gap-12 items-center">
                        ...
                        <div className="flex-1 w-full max-w-md relative">
                            <div className="aspect-square rounded-full bg-gradient-to-tr from-indigo-500 to-purple-600 opacity-20 blur-3xl absolute inset-0 animate-pulse" />
                            <div className="relative z-10 grid grid-cols-2 gap-4">
                                <div className="space-y-4 pt-8">
                                    <CourseValueCard icon={Brain} title="הפרט" color="bg-blue-500" delay={0} />
                                    <CourseValueCard icon={Users} title="הקבוצה" color="bg-purple-500" delay={0.1} />
                                </div>
                                <div className="space-y-4">
                                    <CourseValueCard icon={Network} title="הארגון" color="bg-emerald-500" delay={0.2} />
                                    <CourseValueCard icon={Target} title="האסטרטגיה" color="bg-orange-500" delay={0.3} />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <main className="max-w-7xl mx-auto px-6 py-16 space-y-24">
                ...
                {/* Final CTA */}
                <section className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-3xl p-12 text-center relative overflow-hidden">
                    <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 brightness-100 contrast-150 mix-blend-overlay"></div>
                    <div className="relative z-10 max-w-2xl mx-auto space-y-8">
                        <h2 className="text-4xl font-black text-white">מוכנים להתחיל?</h2>
                        <p className="text-indigo-100 text-lg">
                            הצטרפו למסע המרתק להבנת ההתנהגות האנושית בארגונים. הפרק הראשון מחכה לכם.
                        </p>
                        <Link
                            href="/courses/organizational-behavior/chapter-1"
