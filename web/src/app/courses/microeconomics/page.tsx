...
export default function MicroeconomicsLanding() {
  const chapters = [
    ...
    { num: 4, title: "היצע וביקוש", href: "#", status: "locked" },
    { num: 5, title: "שיווי משקל", href: "#", status: "locked" },
    { num: 6, title: "גמישות", href: "#", status: "locked" },
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12 p-6 bg-slate-900/50 rounded-2xl border border-white/5">
          ...
          <div className="h-2 bg-slate-800 rounded-full overflow-hidden">
            <div className="h-full w-[33%] bg-gradient-to-r from-teal-500 to-emerald-500 rounded-full" />
          </div>
        </div>
            ...
            <Link
              ...
              className={`flex items-center justify-between p-6 rounded-2xl border transition-all ${
                chapter.status === "locked"
                  ...
                  : "border-white/10 bg-slate-900/50 hover:border-teal-500/50 hover:bg-slate-800/50 cursor-pointer"
              }`}
            >
              <div className="flex items-center gap-4">
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center font-black text-lg ${
                  chapter.status === "current" ? "bg-teal-500 text-white" :
