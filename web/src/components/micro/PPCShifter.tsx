    ...
    return (
        <div className="w-full bg-slate-950/50 backdrop-blur-xl border border-white/10 rounded-3xl p-6 md:p-10 shadow-2xl">
            <div className="flex flex-col md:flex-row gap-12">
                ...
                <div className="flex-1 relative aspect-square md:aspect-video bg-slate-900/50 rounded-2xl border border-slate-800 overflow-hidden">
                    {/* Grid Lines */}
                ...
                <div className="w-full md:w-80 space-y-8">
                    <div>
                        ...
                        <p className="text-slate-400 text-sm">שלוט בטכנולוגיה וראה כיצד עקומת התמורה מגיבה.</p>
                    </div>

                    {/* Tech X Control */}
                    <div className="space-y-4 bg-slate-900/30 p-5 rounded-xl border border-white/5">
                        <div className="flex justify-between items-center">
                            <label className="text-slate-200 font-bold">טכנולוגיה במוצר X</label>
                            <span className="text-blue-400 font-mono font-bold">x{techX.toFixed(1)}</span>
                        </div>
                        <input
                            type="range"
                            min="1"
                        ...
                        />
                        <p className="text-xs text-slate-500">למשל: המצאת דשן חדש (משפר עגבניות)</p>
                    </div>

                    {/* Tech Y Control */}
                    <div className="space-y-4 bg-slate-900/30 p-5 rounded-xl border border-white/5">
                        <div className="flex justify-between items-center">
                            <label className="text-slate-200 font-bold">טכנולוגיה במוצר Y</label>
                        ...
                        />
                        <p className="text-xs text-slate-500">למשל: שדרוג תשתיות אינטרנט (משפר הייטק)</p>
                    </div>

                    <div className="pt-4 border-t border-white/10">
                        <button
                            onClick={reset}
                            className="w-full py-3 flex items-center justify-center gap-2 text-slate-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors"
                        >
                            <RefreshCcw size={18} />
                            אפס נתונים
                        </button>
