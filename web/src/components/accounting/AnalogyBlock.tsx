        ...
        <div className={cn("relative group mt-10", className)}>
            ...
            <div className="relative bg-[#1e1933]/40 backdrop-blur-3xl p-8 rounded-[2.5rem] border border-white/5 shadow-2xl overflow-hidden">
                ...
                <div className="flex items-start gap-4">
                    <div className="bg-gradient-to-br from-[#3713ec] to-[#00f3ff] p-2.5 rounded-xl shrink-0 shadow-lg shadow-[#3713ec]/30 group-hover:scale-105 transition-transform duration-500">
                        <Sparkles className="w-5 h-5 text-white" />
                    </div>
                    <div className="space-y-2">
                        <div className="flex items-center gap-3">
                            <h4 className="text-[10px] md:text-xs font-black text-[#00f3ff] uppercase tracking-[0.2em] font-sans leading-none">תובנה מהשטח</h4>
                            <div className="h-[1px] w-12 bg-gradient-to-r from-[#00f3ff] to-transparent opacity-30" />
                        </div>
                        <div
                            className="text-white text-lg md:text-xl leading-relaxed font-sans font-light italic opacity-95 pr-3 border-r border-[#00f3ff]/20"
                ...
                <div className="absolute -right-2 top-1/2 -translate-y-1/2">
                    <div className="w-6 h-6 bg-[#00f3ff]/10 rounded-full flex items-center justify-center">
