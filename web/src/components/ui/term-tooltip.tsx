...
export function TermTooltip({ term, definition, children }: TermTooltipProps) {
    ...
    return (
        ...
        >
            ...
            {/* Tooltip Popup */}
            <div className={cn(
                "absolute bottom-full left-1/2 -translate-x-1/2 mb-4 w-72 p-5 rounded-2xl bg-popover border border-primary/50 shadow-[0_20px_50px_rgba(0,0,0,0.8)] z-50 transition-all duration-300 pointer-events-none font-sans",
                isVisible ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-2 scale-95"
            )}>
                {/* Arrow */}
                <div className="absolute top-full left-1/2 -translate-x-1/2 -mt-2 border-8 border-transparent border-t-primary/50 pointer-events-none" />
