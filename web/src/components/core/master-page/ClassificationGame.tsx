                    ...
                    <div className="relative">
                        <AnimatePresence mode="wait">
                            <motion.div
                                ...
                                exit={{ opacity: 0, y: -20 }}
                                className={cn(
                                    "p-16 rounded-4xl shadow-2xl text-4xl md:text-5xl font-black bg-slate-900/60 border-2 transition-all duration-300 text-center min-h-[280px] flex flex-col items-center justify-center relative overflow-hidden",
