        ...
        <SectionWrapper id="introduction" sectionNumber={2}>
            <div className={cn("w-full space-y-12 py-8", className)}>
                ...
                >
                    ...
                    <p className="text-xl md:text-2xl leading-relaxed text-white font-medium tracking-wide whitespace-pre-wrap">
                        {data.content}
                    </p>
                ...
                >
                    <div className="shrink-0 flex items-center justify-center">
                        <div className="h-24 w-24 rounded-4xl bg-purple-500/10 border-2 border-purple-500/20 flex items-center justify-center text-purple-400 shadow-[0_0_30px_rgba(168,85,247,0.15)] group-hover:rotate-12 transition-all duration-700">
                    ...
                    <div className="space-y-6 relative z-10 w-full flex flex-col justify-center">
                        ...
                        <p className="text-lg md:text-xl text-slate-100 leading-relaxed font-bold tracking-wide">
                            {data.whyItMatters}
                        </p>
                    </div>
