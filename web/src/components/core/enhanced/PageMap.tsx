...
import { Clock, Map } from "lucide-react"; // Removed ArrowLeft if not used
...
interface PageMapProps {
    ...
    courseName?: string; // Added course name prop
}

export const PageMap: React.FC<PageMapProps> = ({
    title,
    data,
    summary,
    currentChapter,
    totalChapters = 12,
    courseName = "הקורס" // Default generic name
}) => {
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 pb-8 border-b border-border/40">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div className="text-foreground font-semibold">{courseName} &gt; פרק {currentChapter}</div>
                        </div>
                    </div>
